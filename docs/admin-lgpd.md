...
- **V7.2** — toda decisão de autenticação e controle de acesso é logada, incluindo falhas (`denied_access`, com throttle anti-flood) e leituras (`whoami`/`list_accounts`/`view_audit`, linha leve sem before/after).
