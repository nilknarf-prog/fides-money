...
const CATEGORIES = {
  ...
  casa_deco:   { label: 'Casa & Decoração', group: 'essencial', tint: '#D97706', emoji: '🛋️' },
  ...
  vestuario:   { label: 'Vestuário',        group: 'estilo',    tint: '#6366F1', emoji: '👕' },
  beleza:      { label: 'Beleza & Cuidados', group: 'estilo',   tint: '#A855F7', emoji: '💇' },
  eletronicos: { label: 'Eletrônicos',      group: 'estilo',    tint: '#64748B', emoji: '📱' },
  outros:      { label: 'Outros',           group: 'estilo',    tint: '#94A3B8', emoji: '📦' },
